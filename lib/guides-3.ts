...
export const guides3: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "복권 당첨금은 기타소득으로 분리과세되고, 세율은 두 개의 기준선으로 나뉩니다. **5만원 이하는 비과세, 5만원 초과 3억원 이하는 22%(소득세 20% + 지방소득세 2%), 3억원 초과분은 33%(30% + 3%)**입니다.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "당첨금은 기타소득으로 분리과세되며 **5만원 이하는 비과세, 5만원 초과 3억원 이하는 22%, 3억원 초과분은 33%**가 원천징수된 뒤 지급됩니다. 즉 실제로 손에 쥐는 금액은 발표된 당첨금보다 적습니다.",
  ...
  {
    slug: "lottery-fund",
    title: "복권 판매액은 어디로 가나 — 당첨금과 복권기금의 구조",
    description:
    ...
    faq: [
      ...
      {
        q: "판매점 수수료는 얼마인가요?",
        a: "통상 판매액의 5% 수준입니다. 여기에 1·2등 배출 시 별도 포상금이 있습니다. 판매점 선정 방식은 이 사이트의 별도 가이드에서 다룹니다.",
      },
    ],
    related: ["unclaimed-prize", "lottery-types", "responsible-play"],
    cta: { href: "/numbers", label: "회차별 판매액·당첨금 보기" },
  },
  {
    slug: "buying-more-odds",
    title: "5천원어치와 5만원어치, 1등 확률은 몇 배 차이일까",
    description:
    ...
    faq: [
      {
        ...
        a: "매 회차가 독립적이라 <언젠가>가 보장되지 않습니다. 같은 번호를 매주 사도 각 회차의 확률은 814만분의 1로 동일합니다. 이 사이트의 별도 가이드에서 자세히 다룹니다.",
      },
      {
      ...
      {
        q: "구매 한도가 있나요?",
        a: "1인당 회차별 구매 한도가 정해져 있고, 인터넷 구매에도 별도 한도가 적용됩니다. 과도한 구매를 억제하기 위한 장치입니다.",
      },
      {
        q: "당첨되면 세금은 얼마나 떼나요?",
        a: "기타소득으로 원천징수되며 금액 구간에 따라 세율이 다릅니다. 지방소득세도 함께 부과됩니다. 이 사이트의 당첨금 세금 가이드에서 확인하세요.",
      },
    ],
    related: ["odds", "statistics-myth", "responsible-play"],
    cta: { href: "/stats", label: "번호별 출현 통계 보기" },
  },
  {
    ...
    related: ["tax", "buying-more-odds", "responsible-play"],
    cta: { href: "/check", label: "내 번호 당첨 확인하기" },
  },
];
